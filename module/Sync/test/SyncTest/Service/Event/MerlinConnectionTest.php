...
/**
 * @covers \Sync\Service\Event\MerlinConnection
 */
class MerlinConnectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function Setup()
    {
        ...
        $this->service = new MerlinConnection(
            $this->clientMock,
            $this->loggerMock,
            self::USERNAME,
            self::PASSWORD,
